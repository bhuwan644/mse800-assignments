...
def calculation():
    ...
    rainfall_more_than_5mm=np.where(sample_rainfall_array_via_numpy>5.0)
    print(f"Total rainfall for the week is : {total_rainfall}\nAverage rainfall for the week is : {average_rainfall}\nTotal no rain days:{no_rain_days}\nTotal days where rainfall was more than 5mm:{rainfall_more_than_5mm}")
